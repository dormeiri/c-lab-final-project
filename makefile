...
OBJ = src/helpers/Error.o src/helpers/Parsing.o src/helpers/Validations.o src/helpers/Queue.o src/helpers/List.o src/helpers/Files.o src/entities/Word.o src/entities/Address.o src/entities/ImageLine.o src/entities/Statement.o src/StepOne.o src/StepTwo.o src/entities/Symbol.o src/Assembler.o
